...
def general_ocr_sd3_4gpu():
    ...
    config.save_freq = 60 # epoch
    config.eval_freq = 60
    config.save_dir = 'logs/ocr/sd3.5-M-OCR-GRPO'
    config.reward_fn = {
        "ocr": 1.0,
    }
...
def general_ocr_sd3_gmpo_4gpu():
    ...
    config.save_freq = 60 # epoch
    config.eval_freq = 60
    config.save_dir = 'logs/ocr/sd3.5-M-OCR-GMPO'
    config.reward_fn = {
        "ocr": 1.0,
    }
...
def pickscore_sd3_4gpu():
    ...
    # sd3.5 medium
    config.pretrained.model = "/users/y/a/yaofeng/flow_grpo/stable-diffusion-3.5-medium"
    config.sample.num_steps = 10
    config.sample.eval_num_steps = 40
    config.sample.guidance_scale = 4.5
    ...
    config.save_freq = 60 # epoch
    config.eval_freq = 60
    config.save_dir = 'logs/pickscore/sd3.5-M-GRPO-2'
    config.reward_fn = {
        "pickscore": 1.0,
    }
...
def pickscore_sd3_gmpo_4gpu():
    ...
    config.save_freq = 60 # epoch
    config.eval_freq = 60
    config.save_dir = 'logs/pickscore/sd3.5-M-GMPO-4'
    config.reward_fn = {
        "pickscore": 1.0,
    }
...
def pickscore_flux_4gpu():
    ...
    # flux
    config.pretrained.model = "/users/y/a/yaofeng/flow_grpo/FLUX.1-dev"
    config.sample.num_steps = 6
    config.sample.eval_num_steps = 28
    config.sample.guidance_scale = 3.5
    ...
    config.eval_freq = 5 # epoch
    config.save_dir = 'logs/pickscore/flux-group24-4gpu'
    config.reward_fn = {
        "pickscore": 1.0,
    }
